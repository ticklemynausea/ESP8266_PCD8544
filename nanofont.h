#ifndef __nanofont_h__
#define __nanofont_h__

// bitmap font data from: https://github.com/Michaelangel007/nanofont3x4
...
{           // Hex    [1] [2] [3] [4] Scanlines
    ...
    0xA440, // 0x59 Y 101 010 010
    0xE4E0, // 0x5A Z 111 010 111
#endif __USE_LOWERCASE__
#ifdef __USE_LOWERCASE__
